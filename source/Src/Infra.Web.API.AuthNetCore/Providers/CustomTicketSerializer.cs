...
namespace Microsoft.AspNetCore.Authentication
{
    ...
    public class CustomTicketSerializer : IDataSerializer<AuthenticationTicket>
    {
        ...
        public static CustomTicketSerializer Default { get; } = new CustomTicketSerializer();
        ...
        protected virtual void WriteClaim(BinaryWriter writer, Claim claim)
        {
            ...
            writer.Write(claim.Value.Length.ToString());
        ...
        protected virtual Claim ReadClaim(BinaryReader reader, ClaimsIdentity identity)
        {
            ...
            int valueLength = int.Parse(reader.ReadString());
            string value = ReadClaimValue(reader, valueLength);
        ...
        private string ReadClaimValue(BinaryReader reader, int valueLength)
        {
